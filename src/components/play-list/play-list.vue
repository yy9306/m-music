<template>
  <transition name="list-fade">
     <div class="playlist" v-show="showFlag" @click="hide">
        ...
        <confirm @confirm="confirmClear" text="是否清空播放列表" confirmBtnTextt="清空" ref="confirm"></confirm>
...
<script>
 ...
 export default{
   ...
   computed: {
     modeText () {
       return this.mode === playmode.sequence ? '单曲播放' : this.mode === playmode.loop ? '循环播放' : '随机播放'
     }
   },
   watch: {
     currentSong (newSong, oldSong) {
       if (newSong === oldSong || !this.showFlag) {
         return
       }
       setTimeout(() => {
